...
const properties = [
  ...
  },
  {
    ...
    description:
      "Nestled among tea plantations, this cottage offers cool mornings, misty views, and a quiet rhythm. The living room opens to a private garden with seating for stargazing, while the bedroom features warm wood accents and plush linens. A compact kitchen makes simple meals easy, and nearby trails lead to waterfalls and scenic lookouts. Perfect for couples who love nature and slow travel."
  },
  {
  ...
  },
  {
    ...
    description:
      "Sleek and bright, this studio sits near the iconic seafront promenade. Floor-to-ceiling windows frame the skyline, while the compact kitchen and smart storage make longer stays comfortable. Walk to cafes, galleries, and late-night street food, then return to a quiet, air-conditioned space. Ideal for business travelers or solo explorers who want a central base with style."
  },
  {
...
const insert = db.prepare(
  `INSERT INTO properties (title, location, price, rating, images, description)
